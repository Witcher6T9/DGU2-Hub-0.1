      ...
      <div className="relative w-full max-w-xl bg-[#faf8f4] border border-[#d9d2c2] rounded-3xl shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-5 bg-gradient-to-r from-[#176f78] via-[#10565e] to-[#0d444a] text-white flex items-center justify-between border-b border-teal-800">
          ...
          {onCancel && (
            <button
              onClick={onCancel}
              className="text-white/80 hover:text-white px-3 py-1 rounded-xl hover:bg-white/10 text-xs font-bold transition-colors cursor-pointer"
            >
        ...
        <div className="px-6 pt-3 pb-1 border-b border-[#e7e1d5] bg-white flex items-center gap-1.5 overflow-x-auto no-scrollbar">
          ...
          <button
            type="button"
            onClick={() => setAuthMode('quick_role')}
            className={`px-3 py-2 text-xs font-bold rounded-xl transition-all flex items-center gap-1.5 cursor-pointer shrink-0 ${
              authMode === 'quick_role'
                ? 'bg-[#176f78] text-white shadow-2xs'
                : 'text-[#506e75] hover:bg-[#f1eee6]'
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 rounded-xl border border-[#d9d2c2] bg-white text-xs font-semibold text-[#17343a] focus:outline-hidden focus:border-[#176f78]"
                    >
                      <option value="Blue Wing">Blue Wing (Lines 18-24)</option>
                      <option value="Green Wing">Green Wing (Lines 01-17)</option>
                      <option value="All">All Factory Wings</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2.5 rounded-xl border border-[#d9d2c2] bg-white text-xs font-semibold text-[#17343a] focus:outline-hidden focus:border-[#176f78]"
                    >
                      <option value="tier_3">Tier 3: IE In-Charge</option>
                      <option value="tier_4">Tier 4: Line IE</option>
                      <option value="tier_2">Tier 2: Production Mgr</option>
                      <option value="tier_1">Tier 1: Sr. Manager</option>
                    </select>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="Enter workstation PIN or password"
                      className="w-full pl-9 pr-10 py-2.5 rounded-xl border border-[#d9d2c2] bg-white text-xs text-[#17343a] focus:outline-hidden focus:border-[#176f78] transition-colors"
                    />
