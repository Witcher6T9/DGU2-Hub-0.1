          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            {onOpenScorecard && (
              <button
                ...
                className="hidden md:flex h-9 px-2.5 sm:px-3 rounded-xl border border-[#176f78]/30 bg-[#176f78]/10 hover:bg-[#176f78] text-[#176f78] hover:text-white items-center gap-1.5 transition-all text-xs font-bold cursor-pointer shadow-2xs group touch-manipulation active:scale-95 shrink-0"
              >
